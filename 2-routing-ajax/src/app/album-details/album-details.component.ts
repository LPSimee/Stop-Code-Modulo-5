...
export class AlbumDetailsComponent {
    ...
    getAlbumDetails(id: number): void {
        this.httpService.getAlbumById(id).subscribe(
            {
                next: (album) => {
                    // For each photo in the album, I will add a new property called "imgUrl" that will contain a random color generated by the getRandomBgColor() method since the "url" and "thumbnailUrl" properties links are no longer available
